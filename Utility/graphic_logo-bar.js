...
document.write('<TABLE cellpadding=0 cellspacing=0 border=0 width="100%" bgcolor="#000000"><tr> <!-- <td width="15">');
document.write('<img src="picts/spacer.gif" HEIGHT=10 WIDTH=15 border="0"><BR> ');
document.write('</td> --> <td ALIGN="LEFT" VALIGN="CENTER">');
document.write('<nobr><a href="index.htm"><img src="picts/logo.gif" border="0"></a></nobr><br>');
