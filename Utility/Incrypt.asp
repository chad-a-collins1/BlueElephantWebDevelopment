<%
Function fn_IncryptString(strInput)

    Dim strEncode, strH(4)
    Dim intPos
    
    
    If len(strInput) = 0 or len(strInput) >= 2^61 then
		fn_IncryptString = "0000000000000000000000000000000000000000"
		exit function
    end if
    ...
    For intPos = 1 to len(strInput) step 56
		
		strEncode = Mid(strInput, intPos, 56) 'get 56 character chunks
    ...
    fn_IncryptString = strH(0) & strH(1) & strH(2) & strH(3) & strH(4)
