...
strRS1 = "SELECT * FROM genericMOUfragments"
strRS2 = "SELECT * FROM genericMOUfragments"
...
Response.Write "<br><br>"
	...
	Response.Write " " & "Insert Client Biz name#############################"
	...
	Response.Write "<br><br>"
	Response.Write "e)	Governing Law.  This Agreement shall be governed by and construed in accordance with the law of the State of California."
	Response.Write "<br><br>"
