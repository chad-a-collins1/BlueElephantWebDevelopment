...
'***************************************************************************************************
Function fn_DL_ValidateEmail(ByVal strEmail, strPwd, strUN)
    ...
    strSQL = strSQL & " " & Chr(13) & "SELECT"
    strSQL = strSQL & " " & Chr(13) & "a.account_id,"
    strSQL = strSQL & " " & Chr(13) & "a.account_password,"
    strSQL = strSQL & " " & Chr(13) & "a.username,"
    strSQL = strSQL & " " & Chr(13) & "ci.email"
    strSQL = strSQL & " " & Chr(13) & ""
    strSQL = strSQL & " " & Chr(13) & "FROM"
    strSQL = strSQL & " " & Chr(13) & "Account a," 
    strSQL = strSQL & " " & Chr(13) & "ContactInfo ci" 
    strSQL = strSQL & " " & Chr(13) & ""
    strSQL = strSQL & " " & Chr(13) & "WHERE"
    strSQL = strSQL & " " & Chr(13) & "ci.email = '" & strEmail & "'"
    strSQL = strSQL & " " & Chr(13) & "and a.account_id = ci.account_id"
    ...
    With rsTmp
       If Not .EOF and Not.BOF Then
          strPwd = .Fields("account_password")
	  strUN = .Fields("username")
       End If
       .Close
    End With  'rsTmp
