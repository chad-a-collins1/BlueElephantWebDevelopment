...
' Approve Requirement
'***************************************************************************************************
Function fn_DL_ApproveRequirement(ByVal lngReqId, ByVal strLUDateTime)
    ...
    strSQL = ""
    strSQL = strSQL & " " & Chr(13) & "UPDATE Requirement" & vbCrLf
    strSQL = strSQL & " " & Chr(13) & "SET last_update_datetime = '" & strLUDateTime & "'," & vbCrLf
    strSQL = strSQL & " " & Chr(13) & "approved_date = '" & strLUDateTime & "'," & vbCrLf
    strSQL = strSQL & " " & Chr(13) & "status_code = 'APPROVED'" & vbCrLf
    strSQL = strSQL & " " & Chr(13) & "WHERE requirement_id = " & lngReqId
    ...
    'If Err.Number <> 0 Then
    '   fn_DL_ApproveRequirement = Err.Number
    '   Exit Function
    'End If
    
    fn_DL_ApproveRequirement = 0

End Function  'fn_DL_ApproveRequirement
